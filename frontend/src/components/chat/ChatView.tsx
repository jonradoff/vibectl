...
export default function ChatView({
  ...
  return (
    <div className="flex flex-col h-full bg-gray-900">
      ...
      {/* Transient status banners — PINNED above the input (outside the
          scrollable messages area) so users always see them regardless of
          scroll position. When these lived inside the messages container,
          a mid-scroll user typing /compact never saw the "Compacting..."
          spinner — the banner rendered below their viewport and vanished
          on 'restarted' before they scrolled down. */}
      {isReconnecting && (
        <div className="shrink-0 mx-2 mb-1 flex items-center gap-2 text-amber-400 text-xs px-2 py-1.5 rounded bg-amber-900/20 border border-amber-700/30">
          <span className="flex gap-1">
      ...
      {compactingLabel && (
        <div className="shrink-0 mx-2 mb-1 flex items-center gap-2 text-cyan-400 text-xs px-2 py-1.5 rounded bg-cyan-900/20 border border-cyan-700/30">
