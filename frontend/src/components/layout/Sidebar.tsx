      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <div className="pt-6">
          ...
          <div className="space-y-0.5">
            ...
            <a href="/docs/skill.md" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors text-gray-400 hover:text-gray-200 hover:bg-gray-800/50">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
