...
import { listIssues, listArchivedIssues, restoreIssue, permanentDeleteIssue } from '../../api/client';
              ...
              <table className="w-full text-left text-sm text-gray-300">
                ...
                <tbody>
                  {filtered.map((issue) => (
                    <tr
                      key={issue.id}
                      className="cursor-pointer border-b border-gray-700/50 bg-gray-800 hover:bg-gray-750 hover:bg-gray-700/50"
