...
func (s *VibectlMdService) Generate(ctx context.Context, projectID string) (string, error) {
	...
	b.WriteString("> **This file is auto-generated by VibeCtl. Do not edit manually.**\n")
	b.WriteString("> It provides agents with contextual knowledge of the project's current state across\n")
	b.WriteString("> issue tracking, feedback, deployments, health monitoring, and recent development activity.\n")
	b.WriteString("> Regenerated automatically on session start. The [Notes] section is the only part preserved across regenerations.\n\n")

	// Meta
	b.WriteString("## Meta\n")
	fmt.Fprintf(&b, "- **Generated:** %s (VibeCtl v%s)\n", now.Format(time.RFC3339), s.version)
	fmt.Fprintf(&b, "- **Project Code:** %s\n", project.Code)
